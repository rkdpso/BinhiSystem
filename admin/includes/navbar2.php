<header class="main-header">
    ...
    <a href="home2.php" class="logo text-green">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu ">
            ...
            <ul class="dropdown-menu bg-success" style="border-radius:15px 0px 0px 15px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
              <!-- User image -->
              ...
              <li class="user-footer bg-warning" style="border-radius:0px 0px 0px 15px; color: ##fcf8e3">
                <div class="pull-left">
