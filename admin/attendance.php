        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="attendance_print.php" class="btn btn-outline btn-success bg-green-600 border-green-400 rounded-full  btn-sm"><span class="glyphicon glyphicon-print"></span> Print</a>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-outline btn-success bg-green-400 border-green-400 rounded-full  btn-sm edit' data-id='".$row['attid']."'><i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-outline btn-danger bg-gray-300 text-black rounded-full btn-sm  delete' data-id='".$row['attid']."'><i class='fa fa-trash'></i> Delete</button>
                          </td>
                        </tr>
                      ";
                    }
