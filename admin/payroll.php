      ...
      ?>
                <div class="row">
                            ...
                            <div class="box-header with-border">
                                <div class="pull-right">
                                    <form method="POST" class="form-inline" id="payForm">
                                        ...
                                        <button type="button" class="btn btn-outline  bg-green-300 text-black rounded-full btn-sm " id="payroll"><span class="glyphicon glyphicon-print"></span> Payroll</button>
                                        <button type="button" class="btn btn-outline  bg-blue-300 text-black rounded-full btn-sm" id="payslip"><span class="glyphicon glyphicon-print"></span> Payslip</button>
                                    </form>
                                </div>
                            </div>
                            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      $gross = $row['rate'] * $row['total_hr']; /*plus overtime pa sana*/
                      ...
                      $total_deduction = (($deduction/100)*$gross) + $cashadvance + $tax;
